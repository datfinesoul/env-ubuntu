...
let g:polyglot_disabled = ['hcl', 'typescript', 'typescriptreact', 'graphql']

syntax on
filetype plugin indent on

" Force Vim's built-in TypeScript syntax instead of polyglot's YATS
" (polyglot ignores g:polyglot_disabled for typescript due to a timing bug)
augroup polyglot_typescript_fix
  autocmd!
  autocmd FileType typescript,typescriptreact
    \ syntax clear |
    \ runtime! syntax/javascript.vim |
    \ unlet! b:current_syntax |
    \ runtime! /usr/share/vim/vim91/syntax/typescript.vim
augroup END
...
let g:coc_global_extensions = ['coc-tsserver', 'coc-eslint', 'coc-json', 'coc-git']
